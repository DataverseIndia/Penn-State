...
const Offerings: FC = () => {
  return (
    <section className='bg-neutral-200 py-10 px-[10vw] mx-auto'>
      <h1 className='font-relative-bold text-4xl mb-10 tracking-tight'>Explore our academic offerings, Chart your path to sucess</h1>
      <div className='grid grid-cols-2 gap-10 justify-center items-center'>
         <div className='w-full mx-auto flex justify-start'>
            <Image src='/images/offerings.png' className='object-cover rounded-md'/>
         </div>
