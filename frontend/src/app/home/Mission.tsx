    ...
    <section className='bg-neutral-950 p-20'>
      <div className='grid grid-cols-2 gap-20'>
         <div className='flex flex-col gap-5'>
            <h1 className='text-teal-500 font-roboto-serif font-semibold'>Our Mission</h1>
            <h1 className='text-white text-5xl font-semibold font-roboto-serif'>Our vision and Plannings</h1>
